...
public class CorporateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void FaxPost(){
        if (faxNo.equals("") || faxNo == null)
        {
            ...
            txtFax1.setText(faxNo);
            txtFax2.setText(faxNo);
            txtFax3.setText(faxNo);
            txtFax4.setText(faxNo);
            txtFax5.setText(faxNo);
            txtFax6.setText(faxNo);
        }
        ...
        if (poBoxNo.equals("") || poBoxNo == null)
        {
            ...
            txtPo1.setText(poBoxNo);
            txtPo2.setText(poBoxNo);
            txtPo3.setText(poBoxNo);
            txtPo4.setText(poBoxNo);
            txtPo5.setText(poBoxNo);
            txtPo6.setText(poBoxNo);
        }
            ...
            if (resultCode == RESULT_OK) {
                ...
                if(message != null)
                    try {
                        ...
                        saveUserImage(getIntent().getExtras().getString("name"), getIntent().getExtras().getString("address"), getIntent().getExtras().getString("phone"), getIntent().getExtras().getString("weblink"), getIntent().getExtras().getString("email"), getIntent().getExtras().getString("position"), sharedPreferenceClass.getUid(), getIntent().getExtras().getString("color_code"), getIntent().getExtras().getString("color_code"), usedLayout, faxNo, poBoxNo, getIntent().getExtras().getString("company"), "1", file);
